...
module.exports = {
  indexes: [
    ...
    { index_code: "CSIH30269", method: "EP", section: "盈利收益率法", name: "红利低波", fundCode: "512890", fundFcode: "007466", source: "csindex" },
    { index_code: "CSI930740", method: "EP", section: "盈利收益率法", name: "300红利LV", fundCode: "512530", fundFcode: "007606", source: "csindex" },
    ...
    { index_code: "SH000903", method: "PE", section: "市盈率法", name: "中证100", fundCode: "512910", fundFcode: "213010", source: "csindex" },
    ...
    { index_code: "SH000991", method: "PE", section: "市盈率法", name: "全指医药", fundCode: "159938", fundFcode: "001180", source: "csindex" },
    { index_code: "SH000978", method: "PE", section: "市盈率法", name: "医药100", fundFcode: "001550", source: "csindex" },
    { index_code: "SH000932", method: "PE", section: "市盈率法", name: "主要消费", fundCode: "510630", fundFcode: "000248", source: "csindex" },
    { index_code: "SH000989", method: "PE", section: "市盈率法", name: "全指可选", fundCode: "159936", fundFcode: "001133", source: "csindex" },
    { index_code: "SZ399396", method: "PE", section: "市盈率法", name: "国证食品", fundCode: "159862", fundFcode: "160222" },
    { index_code: "SH000919", method: "EP", section: "盈利收益率法", name: "300价值", fundCode: "562320", fundFcode: "310398", source: "csindex" },
    { index_code: "SZ399324", method: "PE", section: "市盈率法", name: "深证红利", fundCode: "159905", fundFcode: "481012" },
    { index_code: "SZ399812", method: "PE", section: "市盈率法", name: "养老产业", fundCode: "516560", fundFcode: "000968", source: "csindex" },
    { index_code: "CSIH30533", method: "PE", section: "市盈率法", name: "中概互联50", fundCode: "513050", fundFcode: "006327", source: "csindex" },
    { index_code: "CSIH11136", method: "PE", section: "市盈率法", name: "中国互联", fundCode: "164906", fundFcode: "164906", source: "csindex" },
    { index_code: "HKHSTECH", method: "PE", section: "市盈率法", name: "恒生科技", fundCode: "513180", fundFcode: "012349" },
    { index_code: "CSI931087", method: "PE", section: "市盈率法", name: "科技龙头", fundCode: "515000", fundFcode: "007873", source: "csindex" },
    { index_code: "SH000993", method: "PE", section: "市盈率法", name: "全指信息", fundCode: "512330", fundFcode: "002974", source: "csindex" },
    { index_code: "CSI930652", method: "PE", section: "市盈率法", name: "中证电子", fundCode: "515260", fundFcode: "012651", source: "csindex" },
    { index_code: "SZ399610", method: "PE", section: "市盈率法", name: "TMT50", fundCode: "159909", fundFcode: "160224" },
    { index_code: "CSI931079", method: "PE", section: "市盈率法", name: "5G通讯", fundCode: "515050", fundFcode: "008086", source: "csindex" },
    { index_code: "SZ399417", method: "PE", section: "市盈率法", name: "新能源车", fundCode: "515030", fundFcode: "160225" },
    { index_code: "SZ399971", method: "PE", section: "市盈率法", name: "中证传媒", fundCode: "512980", fundFcode: "004752", source: "csindex" },
    { index_code: "SZ399998", method: "PB", section: "市净率法", name: "中证煤炭", fundCode: "515220", fundFcode: "008279" },
    { index_code: "CSI931142", method: "PE", section: "市盈率法", name: "东证竞争", fundFcode: "007658", source: "csindex" },
    { index_code: "CSI931157", method: "EP", section: "盈利收益率法", name: "沪港深红利低波", fundFcode: "007751", source: "csindex" },
    { index_code: "SH000827", method: "PB", section: "市净率法", name: "中证环保", fundCode: "512580", fundFcode: "001064" },
    { index_code: "CSI930782", method: "PE", section: "市盈率法", name: "500低波", fundCode: "512260", fundFcode: "003318", source: "csindex" },
  ...
  // 整体市场星级模型（复刻螺丝钉星级算法核心）
  // 依据：星级与「中证全指(000985)」估值相关性最强（螺丝钉直播课：星级衡量市场整体估值，
  // 与全指/万得全A 相关性最高，其次 300/800/A500/偏股基金指数）。
  // 映射：一星 ≈ 市场估值上下波动 20%（下行 3.9星跌20%→4.9星），即每 1 星对应 PE×1.25 的对数档位。
  // 经验锚定：PE=refPe 时 = 5 星；s = 5 - ln(PE/refPe)/ln(step)。2024-02-05 熊底 PE=11.94→5.9星、
  // 2026-08-31 PE=18.27→4星、2026-05-12 本轮顶 PE=19.79→3.6星、2015-06 PE=31.64→1.5星，均验证通过。
  starModel: {
    indexCode: "000985",   // 中证全指（官网无前缀代码）
    refPe: 14.6,           // 参考 PE：该值对应 5 星
    step: 1.25,            // 每 1 星 = PE × step（对数刻度）
  },
  // 备用星级基准（官网000985抓取失败时回退：沪深300+中证500+中证1000 等权百分位）
  starBenchmark: ["SH000300", "SH000905", "SH000852"],

  // 红黄绿阈值（按历史百分位，适用于 PE/PB 方法）
  colorThreshold: { low: 0.2, high: 0.8 },

  // 百分位历史窗口：近 N 个交易日用于计算 PE 历史分位。
  // 原为 5 年（1220），经 9-1 与螺丝钉表校准对比发现 5 年窗口对当前估值过敏感
  // （中证500 5年=82.7%红，螺丝钉判黄）；改为 10 年（2440）后中证500=79.4%判黄，
  // 与螺丝钉判断高度一致，其余宽基/行业保持黄/绿不变。
  percentileWindow: 2440,

  // 盈利收益率法（EP）绝对阈值（格雷厄姆法：EP>10%可投，卖出线与国债利率2倍动态挂钩，当前国债约1.7%，设置4%为红线）
  // EP > 10% → 低估可投(绿)；4% ~ 10% → 持有(黄)；< 4% → 卖出(红)
  epThreshold: { buy: 0.10, sell: 0.04 },
